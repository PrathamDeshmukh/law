                ...
                <div class="v-center">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <h1 class="wow fadeInUp" data-wow-delay=".6s">Family Matter/ Court Work</h1>
                ...
                <div class="container-fluid">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-4 col-md-6 text-center text-light">
                            <h3 class="padding40 no-margin">Family Matter</h3>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="feature-box f-boxed style-3 text-center">
                                ...
                                <a href="<?php echo base_url(); ?>#" class="btn-custom btn-black">Contact Us</a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="feature-box f-boxed style-3 text-center">
                                ...
                                <div class="spacer-single"></div>
                                <a href="<?php echo base_url(); ?>#" class="btn-custom btn-black">Talk to Us</a>
                            </div>
                        </div>
